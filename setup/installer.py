...
def basic_tools():
    ...
    os.system('sudo apt install -y xclip neovim git xdotool flameshot blueman fonts-firacode tilix git-cola xscreensaver-gl-extra xscreensaver-data-extra figlet')
    _non_git()
    _tilix()
    _lxqt()
